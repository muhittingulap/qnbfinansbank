...
Aynı bu set işlemini 'Customer' içinde alıcı bilgilerini yazıp yapmalı ve aşağıdaki 'Supplier' yazan yeri değiştirip set etmelisiniz.
    ...
    <?php     
      ...
      $veri = array(
        "Party" => array(
            "WebsiteURI" => "",
            "PartyIdentificationID" => 8720616074,
            "PartyName" => "TuruncuNet İletişim San. Tic. Ltd. Şti.",
            "Telephone" => "08502776464",
            "Telefax" => "",
            "ElectronicMail" => "info@turuncunet.com.tr",
            "PartyTaxSchemeName" => "Uşak",
        ),
        "PostalAddress" => array(
            "StreetName" => "Durak Mh. Gazi Bulv. Özpınar Apt. Sit.",
            "BuildingNumber" => "13/B",
